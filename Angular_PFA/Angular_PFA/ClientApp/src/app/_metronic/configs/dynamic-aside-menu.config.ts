...
export const DynamicAsideMenuConfig = {
  items: [
    ...
    { section: 'Online Requests',
      translate: 'MENU.ONLINE_REQ', },
    {
      title: 'Papers',
      root: true,
      icon: 'flaticon2-architecture-and-city',
      svg: './assets/media/svg/icons/Home/Library.svg',
      page: '/student/papers-list',
      translate: 'MENU.PAPERS',
      bullet: 'dot',
    ...
    },
    {
      ...
      icon: 'flaticon2-architecture-and-city',
      svg: './assets/media/svg/icons/Home/Library.svg',
      page: '/papers/papers-list',
      translate: 'MENU.ADMIN_PAPERS',
      bullet: 'dot',
    ...
    },
    {
      ...
      root: true,
      icon: 'flaticon2-architecture-and-city',
      svg: './assets/media/svg/icons/Files/User-folder.svg',
      page: '/admin/students',
      ...
      role: [ROLESEnum.ADMIN]},
    {
      ...
      root: true,
      icon: '',
      svg: './assets/media/svg/icons/Home/Key.svg',
      page: '/admin/roles',
